...
class StationDistanceUiTests(unittest.TestCase):
    ...
    def test_map_mask_uses_theme_tint_layer_between_tiles_and_overlays(self) -> None:
        ...
        self.assertIn("return intensity * 0.5;", map_script_source)
        self.assertIn("return intensity * 0.5;", detail_script_source)
        self.assertIn("return intensity * 0.9;", map_script_source)
        self.assertIn("return intensity * 0.9;", detail_script_source)
        self.assertIn(".map-canvas .leaflet-tile-pane::after", map_stylesheet_source)
        self.assertIn(".station-detail-map-canvas .leaflet-tile-pane::after", app_stylesheet_source)
