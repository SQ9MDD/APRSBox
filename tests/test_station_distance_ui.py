...
class StationDistanceUiTests(unittest.TestCase):
    ...
    def test_map_dimming_filters_only_leaflet_tiles(self) -> None:
        ...
        self.assertIn("filter: brightness(var(--map-tile-brightness));", app_stylesheet_source)
        self.assertNotIn("mapMask", map_script_source)
        self.assertNotIn("mapMask", detail_script_source)
        self.assertNotIn("mapMaskPane", map_script_source)
        self.assertNotIn("mapMaskPane", detail_script_source)
