...
class StationSettingsAndSchedulerTests(unittest.TestCase):
    ...
    def test_station_save_uses_settings_style_progress_modal(self) -> None:
        ...
        self.assertIn('class="settings-progress-backdrop" id="station-manual-send-confirm-modal"', template_source)
        self.assertIn('class="settings-progress-backdrop" id="station-beacon-confirm-modal"', template_source)
        self.assertNotIn('class="beacon-confirm-modal"', template_source)
        self.assertNotIn('class="beacon-confirm-dialog"', template_source)
