...
class AprsAlertTests(unittest.TestCase):
    ...
    def test_shared_modal_is_rendered_from_base_and_opened_by_alert_list(self) -> None:
        ...
        self.assertIn('id="aprs-emergency-areas-row"', modal_source)
        self.assertIn("area_feature_collection", modal_js_source)
        self.assertIn("window.L.geoJSON", modal_js_source)
