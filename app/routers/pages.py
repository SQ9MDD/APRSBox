...
def objects_create(
    ...
    payload = {
        ...
        "first_activation_utc": first_activation_utc.strip(),
        ...
        "recurrence_until_utc": recurrence_until_utc.strip(),
        "path": path.strip(),
        "is_enabled": is_enabled,
