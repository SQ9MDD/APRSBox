...
PRIMARY_NAV = [
    ...
    {"key": "nav-separator-primary", "separator": True, "roles": ("admin", "operator")},
    {"key": "station", "label": "My Station", "href": "/station", "roles": ("admin", "operator"), "icon": "antenna.svg"},
    {"key": "wx", "label": "WX", "href": "/wx", "roles": ("admin", "operator"), "icon": "weather-partly-snowy.svg"},
    {"key": "messages", "label": "Messages", "href": "/messages", "roles": ("admin", "operator"), "icon": "message-reply-text-outline.svg"},
    {"key": "notifications", "label": "Notifications", "href": "/notifications", "roles": ("admin", "operator"), "icon": "bell-outline.svg"},
    {"key": "objects", "label": "Objects / Items", "href": "/objects", "roles": ("admin", "operator"), "icon": "crosshairs.svg"},
    {"key": "bulletins", "label": "Bulletins", "href": "/bulletins", "roles": ("admin", "operator"), "icon": "message-text-outline.svg"},
    {"key": "digi-flows", "label": "Packet Routing", "href": "/digi-flows", "roles": ("admin", "operator"), "icon": "source-branch-check.svg"},
    {"key": "igate", "label": "iGATE settings", "href": "/igate", "roles": ("admin", "operator"), "icon": "lan-connect.svg"},
    {"key": "nav-separator-secondary", "separator": True, "roles": ("admin", "operator")},
    {"key": "logs", "label": "Logs", "href": "/logs", "roles": ("admin", "operator"), "icon": "book-open-variant.svg"},
    {"key": "users", "label": "Users / Roles", "href": "/admin/users", "roles": ("admin",), "icon": "account-cog.svg"},
    {"key": "settings", "label": "Settings", "href": "/settings", "roles": ("admin", "operator"), "icon": "cog.svg"},
    {"key": "changelog", "label": "Changelog", "href": "/changelog", "roles": ("admin", "operator"), "icon": "language-markdown-outline.svg"},
]
