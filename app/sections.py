...
SECTION_DEFINITIONS: dict[str, SectionDefinition] = {
    "modems": SectionDefinition(
        slug="modems",
        title="TNC",
        description="Manage TNC definitions used by APRSBox core for TCP monitoring, outbound traffic and optional LAN port sharing.",
        table_name="modems",
        nav_key="modems",
        readonly_message="TNC settings are stored in SQLite and applied by APRSBox core. The current runtime monitor uses the first enabled TNC entry.",
