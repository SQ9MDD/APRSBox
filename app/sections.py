...
SECTION_DEFINITIONS: dict[str, SectionDefinition] = {
    ...
    "objects": SectionDefinition(
        ...
        fields=[
            ...
            {"name": "path", "label": "Path", "type": "text", "required": False, "maxlength": 64, "placeholder": "WIDE2-2"},
    ...
    "items": SectionDefinition(
        ...
        fields=[
            ...
            {"name": "path", "label": "Path", "type": "text", "required": False, "maxlength": 64, "placeholder": "WIDE1-1,WIDE2-1"},
            {"name": "is_enabled", "label": "Active", "type": "checkbox", "required": False},
