...
SECTION_DEFINITIONS: dict[str, SectionDefinition] = {
    ...
    "bulletins": SectionDefinition(
        slug="bulletins",
        title="Bulletins / Messages",
        description="Prepare APRS message-format frames for direct messages, bulletins and announcements.",
        table_name="bulletins",
        nav_key="bulletins",
        readonly_message="APRS messages, bulletins and announcements use the message data type identifier (:). Text is limited to 67 characters and stored as strict ASCII only.",
        list_title="Prepared Bulletins / Messages",
        create_title="Add Bulletin / Message",
        edit_title="Edit Bulletin / Message",
        supports_editing=True,
        supports_delete=True,
        fields=[
            {
            ...
            {"name": "addressee", "label": "Addressee", "type": "text", "required": False, "maxlength": 9, "placeholder": "SQ9XYZ-9"},
