...
- `Condiciones de banda / confianza e historial`: se añadió un índice de confianza que aumenta con la cantidad de datos, junto con un indicador W0–W5 sencillo y un gráfico horario de los últimos 365 días.
