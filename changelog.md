...
- `Warunki pasma / pewność i historia`: dodano rosnący wraz z ilością danych indeks pewności, prosty wskaźnik W0–W5 z wykresem godzinowym obejmującym ostatnie 365 dni oraz dyskretny blok pokazujący zebrane dane, etap uczenia i postęp do pierwszej oraz dojrzałej oceny.
