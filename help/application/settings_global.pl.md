...
- `Włącz rozsuwanie nakładających się markerów` pozwala kliknąć nachodzące na siebie pojedyncze markery blisko maksymalnego zoomu i rozsunąć je bez zmiany ikon APRS ani ich akcji.
