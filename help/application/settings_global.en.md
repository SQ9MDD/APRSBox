...
- `Enable spreading overlapping markers` lets you click overlapping individual markers near the maximum zoom and spreads them apart without changing their APRS icons or actions.
